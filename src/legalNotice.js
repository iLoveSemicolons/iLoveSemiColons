      ...
      <MainLayout>
        ...
        <LegalNoticeContainer className={styles.legalNoticeContainer}>
          ...
          <p>
            ...
            <a href="http://www.ilovesemicolons.io">www.ilovesemicolons.io</a>{" "}
            l'identité des différents intervenants dans le cadre de sa
            réalisation et de son suivi :
          </p>
          <p>
            <strong>Propriétaire</strong> : Sirage AL DBIYAT – – 13 Quai Joseph
            Gillet, 69004 Lyon
            <br />
            <strong>Créateur</strong> :{" "}
            <a href="Url du créateur du site *, ex : http://www.ilovesemicolons.io">
              Sirage AL DBIYAT
            </a>
            <br />
            <strong>Responsable publication</strong> : Sirage AL DBIYAT –
            ilovesemicolons@hotmail.com
            <br />
            Le responsable publication est une personne physique ou une personne
            morale.
            <br />
            <strong>Webmaster</strong> : Sirage AL DBIYAT –
            ilovesemicolons@hotmail.com
            <br />
            <strong>Hébergeur</strong> : DigitalOcean – 101 6th Ave, New York,
          ...
          <p>
            ...
            toutefois décidée par Sirage AL DBIYAT, qui s’efforcera alors de
          ...
          <p>
            Le site{" "}
            <a href="http://www.ilovesemicolons.io">www.ilovesemicolons.io</a>{" "}
            est mis à jour régulièrement par Sirage AL DBIYAT. De la même façon,
          ...
          <p>
            Le site{" "}
            <a href="http://www.ilovesemicolons.io">www.ilovesemicolons.io</a> a
            pour objet de fournir une information concernant l’ensemble des
            activités de la société.
          </p>
          <p>
            Sirage AL DBIYAT s’efforce de fournir sur le site{" "}
            <a href="http://www.ilovesemicolons.io">www.ilovesemicolons.io</a>{" "}
          ...
          <p>
            Sirage AL DBIYAT est propriétaire des droits de propriété
          ...
          <p>
            Sirage AL DBIYAT ne pourra être tenue responsable des dommages
            directs et indirects causés au matériel de l’utilisateur, lors de
            l’accès au site www.ilovesemicolons.io, et résultant soit de
          ...
          <p>
            Sirage AL DBIYAT ne pourra également être tenue responsable des
          ...
          <p>
            ...
            l’espace contact) sont à la disposition des utilisateurs. Sirage AL
            DBIYAT se réserve le droit de supprimer, sans mise en demeure
            ...
            relatives à la protection des données. Le cas échéant, Sirage AL
            DBIYAT se réserve également la possibilité de mettre en cause la
          ...
          <p>
            {" "}
            En tout état de cause Sirage AL DBIYAT ne collecte des informations
          ...
          <p>
            ...
            du rachat de Sirage AL DBIYAT et de ses droits permettrait la
          ...
          <p>
            ...
            mis en place avec l’autorisation de Sirage AL DBIYAT. Cependant,
            Sirage AL DBIYAT n’a pas la possibilité de vérifier le contenu des
